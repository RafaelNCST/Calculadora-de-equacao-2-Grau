let calculatorImgeq2Degree = document.getElementById("imgcalculatoreq2") as HTMLElement;
let formulaImgeq2Degree = document.getElementById("imgformulaeq2") as HTMLElement;
const menueq2 = document.querySelector(".menu") as HTMLElement;
...
(document.querySelector(".suneq2") as HTMLElement).addEventListener("click", sunChangeEq2Degree);

(document.querySelector(".mooneq2") as HTMLElement).addEventListener("click", moonChangeEq2Degree);

menueq2.addEventListener("click", () => {
    const chooseMenuEq2Degree = document.querySelectorAll(".choose-menu") as NodeListOf<HTMLElement>
